...
public class CommandeDAO {
	...
	public void createCommande(String statut, int roleUser, String nom) {

		String query = "insert into cmdeapprodepot(statutCommande, idCatSalarie, nomCommande) values(?,?,?)";

		try (PreparedStatement stmt = cn.laconnexion().prepareStatement(query)) {
			stmt.setString(1, statut);
			stmt.setInt(2, roleUser);
